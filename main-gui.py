...
class admin:
    ...
    def admin_panel(self):
        ...
        e5 = Button(self.root, text="Exit", command=self.control_panel)
        el = [e1, e2, e3, e4, e5]
        i=0
        for element in el:
            Grid.rowconfigure(self.root, i, weight=1)
    ...
    def delete_logs(self):
        ...
        e2 = Button(self.root, text="Exit", command=self.admin_panel)
        el = [e1, e2]
        i=0
        for element in el:
            Grid.rowconfigure(self.root, i, weight=1)
        ...
        for i, user in enumerate(users):
            ...
            for element in el:
                ...
                element.configure(bg=self.bg,
                          ...
                          borderwidth=1)
                c+=1
        e15 = Button(self.root, text="Exit", command=self.control_panel)
        Grid.grid_columnconfigure(self.root, 7, weight=1)
        e15.grid(column=7, sticky= "nsew")
        e15.configure(bg=self.bg,
                          fg=self.fg,
                          activebackground=self.bg,
                          borderwidth=1)
    def add_user(self):
    ...
    def edit_user(self):
        ...
        e7 = Button(self.root, text="Exit", command=self.control_panel)
    ...
    def edit_user_add_balance(self):
        ...
        self.amount.configure(bg=self.bg,
                          fg=self.fg,
                          borderwidth=1)
